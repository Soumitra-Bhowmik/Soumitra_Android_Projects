      ...
      child: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            title: Text("বই সমগ্র",style: TextStyle(fontWeight: FontWeight.bold,color: Color.fromARGB(255, 63, 61, 61)),),
            pinned: true,
            floating: true,
            expandedHeight: 200,
            flexibleSpace: FlexibleSpaceBar(
              title: Padding(
                ...
                child: Text('${widget.hospital.name}',style: TextStyle(fontWeight: FontWeight.bold,color: Color.fromARGB(255, 0, 0, 0)),),
              ),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
                    color: Color.fromARGB(255, 55, 167, 11),
                    boxShadow: [
                      BoxShadow(
                        color: Colors.black,
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  Color.fromARGB(255, 11, 70, 3), 
                                  Color.fromARGB(255, 7, 240, 18),
